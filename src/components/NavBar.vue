<template>
      ...
      <v-toolbar-title>CCCCCC</v-toolbar-title>
        ...
        >
          ...
          <v-list>
            <v-list-item
              ...
              :value="index"
            >
              <router-link to="`/${item.title.toLowerCase()}`"></router-link>
      ...
      <v-btn size="small" icon variant="plain">
        <v-icon>mdi-magnify</v-icon>
          ...
          <v-btn size="small" variant="plain" icon="mdi-home" @click="toggleTheme"></v-btn>
      </v-toolbar-items>
      </v-toolbar>
</template>
